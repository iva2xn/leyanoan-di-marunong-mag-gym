...
export const ICONS: { [key: string]: React.JSX.Element } = {
  ...
  twitter: (
     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.4 3.3 4.4s-1.4 1.4-3.3 1.4H6.7c-3.3 0-3.3-3.3-3.3-3.3s1.4-1.4 3.3-1.4H3.3s.7-2.1 2-3.4c-1.6-1.4-3.3-4.4-3.3-4.4s1.4-1.4 3.3-1.4h13.4c3.3 0 3.3 3.3 3.3 3.3z"></path>
    </svg>
  )
};